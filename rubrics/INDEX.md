...
|---|---|---|---|
| [`RUBRIC_fleet_upgrade_outcome_v1.3.md`](RUBRIC_fleet_upgrade_outcome_v1.3.md) | Fleet upgrade (FLEET-UPG-NNN) | Coverage fidelity, BC management, residual capture, gate discipline, upstream value | Self-check before close-out; principal meta-assessment per release. Max 15. ≥10 required to declare complete. |
